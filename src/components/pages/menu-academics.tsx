...
export function MenuAcademics({
    ...
    const renderNestedSubmenuContent = () => {
        ...
        const submenu = menuItems[3].submenus.find((s) => s.id === showNestedSubmenu)
            ...
            {isOpen && (
                ...
                >
                    <ul className="grid gap-1">
                        {menuItems[3].submenus.map((submenu) => (
                            <li key={submenu.id}>
