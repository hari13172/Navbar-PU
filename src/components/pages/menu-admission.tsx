...
export function MenuAdmission({
    ...
    const renderNestedSubmenuContent = () => {
        ...
        const submenu = menuItems[4].submenus.find((s) => s.id === showNestedSubmenu)
    ...
    return (
        ...
        >
            ...
            {isOpen && (
                ...
                >
                    <ul className="grid gap-1">
                        {menuItems[4].submenus.map((submenu) => (
                            <li key={submenu.id}>
            ...
            {/* Render nested submenu for Admission */}
